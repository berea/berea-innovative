...
/**
 * Class Berea__REST__Main
 *
 * The main entry point for the events calendar REST API implementation.
 *
 * This class should not contain business logic and merely set up and start the REST API support.
 */
abstract class Berea__REST__Main {

	/**
	 * Berea REST APIs URL namespace.
	 *
	 * @var string
	 */
	protected $namespace = 'berea';

	/**
	 * Returns the namespace of Berea REST APIs.
	 *
	 * @return string
	 */
